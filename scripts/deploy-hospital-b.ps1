# PowerShell script to deploy Complete Hospital B System
# This deploys a FULL hospital system with all services on the VM
# Run this from the scripts directory

$HOSPITAL_NAME = "hospital-b"
$HOSPITAL_IP = "172.29.138.240"

Write-Host "=== Deploying Complete Hospital B System ===" -ForegroundColor Green
...
multipass transfer docker-compose.hospital-b.yml "${HOSPITAL_NAME}:/home/ubuntu/docker-compose.yml"
...
Write-Host ""
Write-Host "=== Hospital B System Deployment Complete ===" -ForegroundColor Green
Write-Host ""
Write-Host "Hospital B URLs:" -ForegroundColor Yellow
...
Write-Host "View logs: multipass exec $HOSPITAL_NAME -- docker compose logs -f" -ForegroundColor Cyan
